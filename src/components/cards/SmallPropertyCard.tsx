...
export function SmallPropertyCard({
  ...
  useEffect(() => {
    const updateHeight = () => {
      ...
      if (imageWidthDecider && widthDecider && setWidthDecider && setMapWidth) {
        ...
        const maxWidth = imageWidth + contentWidth + 140;
  ...
  return (
    <Card className='w-full mx-auto shadow-md rounded-2xl bg-[#ffffff] border transition-all duration-300 overflow-hidden '>
